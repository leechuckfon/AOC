...
namespace AOCDay3 {
    class Program {
        ...
        static void Main(string[] args) {
            ...
            var intersections = line1.Intersect(line2);
            Console.WriteLine(intersections.FirstOrDefault().x + intersections.FirstOrDefault().y);
            //var closestCrossing =line1.Find(position => line2.Exists(pos => pos.x == position.x && pos.y == position.y));
            Console.WriteLine(totalSteps);
            s.Stop();
            Console.Write(s.ElapsedMilliseconds / 1000);
            //Console.ReadLine();
            //Console.WriteLine(line1.Count);
